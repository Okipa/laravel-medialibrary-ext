...
class SizeValidationConstraintTest extends TestCase
{
    /** @test */
    public function it_return_none_when_it_is_not_defined()
    {
        config()->set('medialibrary.max_file_size', null);
        $validationConstraint = (new TestModel)->sizeValidationConstraint();
    ...
    public function it_can_return_size_constraint()
    {
        ...
        $captionString = (new TestModel)->sizeValidationConstraint();
